...
#ifndef TMVAapply_all_h
#define TMVAapply_all_h
...
public :
   ...
   TMVAapply_all(TTree *tree=0, TString filename="");
   virtual ~TMVAapply_all();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString inputfile="", TString output_dir="", TString region="");
...
#ifdef TMVAapply_all_cxx
TMVAapply_all::TMVAapply_all(TTree *tree, TString filename) : fChain(0) 
{
...
TMVAapply_all::~TMVAapply_all()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TMVAapply_all::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TMVAapply_all::LoadTree(Long64_t entry)
{
...
void TMVAapply_all::Init(TTree *tree)
{
...
void TMVAapply_all::Show(Long64_t entry)
{
...
Int_t TMVAapply_all::Cut(Long64_t entry)
{
