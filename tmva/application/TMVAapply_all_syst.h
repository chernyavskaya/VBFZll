...
#ifndef TMVAapply_all_syst_h
#define TMVAapply_all_syst_h
...
public :
 ...
 UInt_t          run;
   ...
   Int_t           nLHE_weights_aTGC;
   Int_t           LHE_weights_aTGC_id[130];   //[nLHE_weights_aTGC]
   Float_t         LHE_weights_aTGC_wgt[130];   //[nLHE_weights_aTGC]
   Int_t           nLHE_weights_aTGC_nom;
   Int_t           LHE_weights_aTGC_nom_id[2];   //[nLHE_weights_aTGC]
   Float_t         LHE_weights_aTGC_nom_wgt[2];   //[nLHE_weights_aTGC]
 ...
 TBranch        *b_run;   //!
   ...
   TBranch        *b_nLHE_weights_aTGC;   //!
   TBranch        *b_LHE_weights_aTGC_id;   //!
   TBranch        *b_LHE_weights_aTGC_wgt;   //!
   TBranch        *b_nLHE_weights_aTGC_nom;   //!
   TBranch        *b_LHE_weights_aTGC_nom_id;   //!
   TBranch        *b_LHE_weights_aTGC_nom_wgt;   //!
   ...
   TMVAapply_all_syst(TTree *tree=0, TString filename="");
   virtual ~TMVAapply_all_syst();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString file_tag="", TString output="",TString region="");
...
#ifdef TMVAapply_all_syst_cxx
TMVAapply_all_syst::TMVAapply_all_syst(TTree *tree, TString filename) : fChain(0) 
{
...
TMVAapply_all_syst::~TMVAapply_all_syst()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TMVAapply_all_syst::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TMVAapply_all_syst::LoadTree(Long64_t entry)
{
...
void TMVAapply_all_syst::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nLHE_weights_aTGC", &nLHE_weights_aTGC, &b_nLHE_weights_aTGC);
   fChain->SetBranchAddress("LHE_weights_aTGC_id", LHE_weights_aTGC_id, &b_LHE_weights_aTGC_id);
   fChain->SetBranchAddress("LHE_weights_aTGC_wgt", LHE_weights_aTGC_wgt, &b_LHE_weights_aTGC_wgt);
   fChain->SetBranchAddress("nLHE_weights_aTGC_nom", &nLHE_weights_aTGC_nom, &b_nLHE_weights_aTGC_nom);
   fChain->SetBranchAddress("LHE_weights_aTGC_nom_id", LHE_weights_aTGC_nom_id, &b_LHE_weights_aTGC_nom_id);
   fChain->SetBranchAddress("LHE_weights_aTGC_nom_wgt", LHE_weights_aTGC_nom_wgt, &b_LHE_weights_aTGC_nom_wgt);
...
Bool_t TMVAapply_all_syst::Notify()
{
...
void TMVAapply_all_syst::Show(Long64_t entry)
{
...
Int_t TMVAapply_all_syst::Cut(Long64_t entry)
{
...
#endif // #ifdef TMVAapply_all_syst_cxx
