...
#famc = ROOT.TFile.Open("/afs/cern.ch/work/n/nchernya/VBFZll/plotter/output_root/DYJetstoLL_amc_mu_QCDScalenom_JESnom_v24_ewk_mucorr_Ptsum.root")
#fmdg = ROOT.TFile.Open("/afs/cern.ch/work/n/nchernya/VBFZll/plotter/output_root/DYJetstoLL_HT_mu_QCDScalenom_JESnom_v24_ewk_mucorr_Ptsum.root")
famc = ROOT.TFile.Open("dcap://t3se01.psi.ch:22125//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFZll/plotterOutput/v24/DYJetstoLL_amc_el_QCDScalenom_JESnom_v24_ewk_mucorr_PtsumEtaQQ.root")
fmdg = ROOT.TFile.Open("dcap://t3se01.psi.ch:22125//pnfs/psi.ch/cms/trivcat//store/user/nchernya/VBFZll/plotterOutput/v24/DYJetstoLL_HT_el_QCDScalenom_JESnom_v24_ewk_mucorr_PtsumEtaQQ.root")
...
#	func_res = ROOT.TF1("func","pol7",0,8.3) # for muons EtaQQ corr 
	func_res = ROOT.TF1("func","pol7",0,8.5) # for electrons EtaQQ corr 
#	func_res = ROOT.TF1("func","pol7",0,8.3) # for muons EtaQQ corr 
...
#		print hist_names[num],func_res.GetChisquare(), func_res.GetNDF(), func_res.GetChisquare()/func_res.GetNDF(), func_res.GetX(1.,8.,9.)
	line = ROOT.TLine(xmin,1,xmax,1)
	line.SetLineStyle(3)
	line.Draw("same")
	ROOT.gPad.Update()
	c.SaveAs("plots_amc_mdg_corr/plot_amc_mdg_corr_el_Ptsumcorr_ForEta_%s_after.pdf" %list_amc[num].GetName() )
#	c.SaveAs("plots_amc_mdg_corr/plot_amc_mdg_corr_mu_%s.pdf" %list_amc[num].GetName() )
