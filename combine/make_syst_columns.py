...
with open('results_split_systematics_el_%s.txt'%dy_opt) as f1, open('results_split_systematics_mu_%s.txt'%dy_opt) as f2,open('results_split_systematics_elmu_%s.txt'%dy_opt) as f3, open('unc_splitting_%s.txt'%dy_opt, 'w') as out:
    line_counter=0
