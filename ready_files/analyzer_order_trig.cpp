...
int FILLCOLOR[nfiles] = {1,kRed,kSpring+8, kSpring+5, kGreen-3, kBlue-4,kOrange-2};
int LINECOLOR[nfiles] = {1,kRed,kSpring+8, kSpring+5, kGreen-3,kBlue-4,kOrange-2};
...
for (int i=0;i<nfiles;i++){
	...
	if (i==0) file_names[i].Append("_QCDScalenom_JESnom_v24_ewk_mucorr_Ptsum");
	if (i!=0) {
		file_names[i].Append("_QCDScalenom_JESnom_v24_ewk_mucorr_Ptsum");
		file_names_QCDup[i].Append("_QCDScaleup_JESnom_v24_ewk_mucorr_Ptsum");
		file_names_QCDdown[i].Append("_QCDScaledown_JESnom_v24_ewk_mucorr_Ptsum");
		file_names_JESup[i].Append("_QCDScalenom_JESup_v24_ewk_mucorr_Ptsum");
		file_names_JESdown[i].Append("_QCDScalenom_JESdown_v24_ewk_mucorr_Ptsum");
	}
...
TString trigger[2] = {"", ""};
TString dir_name= "plots_ht_tighttr_mucorr_Ptsum";
...
//Float_t MC_data[2] = {0.879,0.915};//{0.78,1.};//////////amc  (after muon corrections)
//Float_t MC_dataup[2] = {0.841,0.97};//{0.832,1.};//////////amc
//Float_t MC_datalow[2] = {0.78,0.808};//{0.701,1.};//////////amc
//Float_t MC_datajesup[2] = {0.82,0.855};//{0.733,1.};//////////amc
//Float_t MC_datajeslow[2] = {0.964,1}; //{0.861,1.};//////////amc
...
//Float_t MC_data[2] = {1.04, 1./1.};//ht  without qcd
//Float_t MC_dataup[2] = {1.01,1.};//////////ht up   wo wcd
//Float_t MC_datalow[2] = {0.977,1.};//////////ht lo   wo qcd
//Float_t MC_datajesup[2] = {0.968,1.};//////////ht lo   wo qcd
//Float_t MC_datajeslow[2] = {1.13,1.};/////////ht lo wo qcd
